      ...
      <Row>
        ...
        <Col lg='4' md='7' sm='6'>
          ...
          <ListGroupItem className='delivery_time-item border-0 ps-0'>
              <span>Location: Banten.Tanggerang.Indonesia</span>
            </ListGroupItem>
            <ListGroupItem className='delivery_time-item border-0 ps-0'>
        ...
        <Col lg='3' md='4' sm='6'>
         ...
         <div className='newsletter'>
          ...
          <span>
            <i className="ri-send-plane-line"></i></span>
         </div>
        </Col>
        </Row>
      <Row className='mt-5'>
        <Col lg="6" md="6">
         <p className='copyright_text'>
          Copyright - 2023, webside made by Muhammad Fadilah. All Rights Reseverd.</p>
        </Col>
        <Col lg="6" md="6">
          <div className='sosial_links d-flex align-items-center gap-4 justify-content-end'>
            <p className='m-0'>Follow:</p>
            <span>< Link to=""><i className="ri-facebook-line"></i></Link>
            </span>
            <span>< Link to=""><i className="ri-github-fill"></i></Link>
            </span>
            <span>< Link to=""><i className="ri-youtube-fill"></i></Link>
            </span>
            <span>< Link to=""><i className="ri-linkedin-box-fill"></i></Link>
            </span>
          </div>
        </Col>
      </Row>
